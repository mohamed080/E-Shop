                ...
                <div className="container flex justify-between items-center">
                        ...
                        <div className="hidden lg:block">
                            <ul className="flex items-center gap-4">
                                ...
                                <li className="relative cursor-pointer group">
                                    <a href="#" className="flex items-center gap-[2px] font-semibold text-gray-500 dark:hover:text-white py-2 text-black dark:text-white">Quick Links
                                        <span>
                                        ...
                                        <ul className="space-y-2">
                                            {
                                                DropdownLinks.map((data) => (
                                                    <li key={data.id}> 
                                                        <a
                                                        className="text-gray-500 dark:hover:text-white duration-200 inline-block w-full p-2 hover:bg-primary/20 rounded-md"
                    ...
                    <div className="flex justify-between items-center gap-4">
                        <div className="relative group hidden sm:block">
                            ...
                            <IoMdSearch className="absolute text-xl text-gray-600 group-hover:text-primary dark:text-gray-400 top-1/2 -translate-y-1/2 right-3 duration-200" />
                        </div>
